...
// source: phar:///var/www/wp-content/plugins/wp-thumbnail-plugin/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon
...
class Container_0de9c79822 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_0de9c79822 $container)
			{
	...
	public function createServiceContainer(): Container_0de9c79822
	{
		return $this;
	}
