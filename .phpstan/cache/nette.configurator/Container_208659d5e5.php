...
class Container_208659d5e5 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper($this->getService('081'), [], false);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_208659d5e5 $container)
			{
	...
	public function createServiceContainer(): Container_208659d5e5
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/phpstan-baseline.neon',
			'usedLevel' => '5',
