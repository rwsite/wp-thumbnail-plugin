...
class Container_f41464da18 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					'message' => '#^Function get_the_title not found\.$#',
					'count' => 1,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/functions.php',
				],
				[
					'message' => '#^Function thumb_a_img not found\.$#',
					'count' => 1,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/functions.php',
				],
				[
					'message' => '#^Function thumb_img not found\.$#',
					'count' => 2,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/functions.php',
				],
				[
					'message' => '#^Function thumb_src not found\.$#',
					'count' => 1,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/functions.php',
				],
				[
				...
				[
					'message' => '#^Function get_attached_file not found\.$#',
					'count' => 1,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/src/Application/ThumbnailService.php',
				],
				[
					'message' => '#^Function __ not found\.$#',
					'count' => 3,
					'path' => '/var/www/wp-content/plugins/wp-thumbnail-plugin/src/Infrastructure/WordPress/Plugin.php',
				],
				[
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f41464da18 $container)
			{
	...
	public function createServiceContainer(): Container_f41464da18
	{
		return $this;
	}
