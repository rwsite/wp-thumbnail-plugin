...
class Container_3b6fd68439 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3b6fd68439 $container)
			{
	...
	public function createServiceContainer(): Container_3b6fd68439
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => [
				'/var/www/wp-content/plugins/wp-thumbnail-plugin/src',
