...
class Container_b6561feabc extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b6561feabc $container)
			{
	...
	public function createServiceContainer(): Container_b6561feabc
	{
		return $this;
	}
