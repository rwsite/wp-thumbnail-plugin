...
class Container_f0307ab9a6 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			[
				['message' => '#Call to undefined function#', 'paths' => ['*.php']],
				['message' => '#Undefined variable#', 'paths' => ['*.php']],
				['message' => '#Call to undefined method#', 'paths' => ['*.php']],
			],
			false
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f0307ab9a6 $container)
			{
	...
	public function createServiceContainer(): Container_f0307ab9a6
	{
		return $this;
	}
